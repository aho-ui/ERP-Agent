# Disabled — chart rendering moved to frontend via recharts.
# Charts are now returned as raw structured data (chart_type, data, series, x_key).
# Matplotlib PNG generation is no longer used.
