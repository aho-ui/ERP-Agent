...
def parse_agent_response(raw: str, agent_name: str, task: str, q, fallback: str, action_id=None) -> ParseResult:
    ...
    try:
        ...
        if not isinstance(parsed, dict):
            ...
            return ParseResult(summary=fallback, confirmation_required=False)
        ...
        if parsed.get("confirmation_required"):
            ...
            return ParseResult(summary=summary, confirmation_required=True)
        ...
        return ParseResult(summary=summary, confirmation_required=False)
